import { z } from 'zod';
import { sanitizeUserContent, sanitizeSearchQuery, sanitizeFormInput } from './sanitization';
...
export const fileUploadSchema = z.object({
  ...
  type: z.string()
    .refine(
      (val) => ['image/jpeg', 'image/png', 'image/gif', 'image/webp', 'application/pdf'].includes(val),
      'Invalid file type'
    ),
});
 ...
 */
export const validateSearchQuery = (input: unknown) => validateInput(searchQuerySchema, input);
export const validateContactForm = (input: unknown) => validateInput(contactFormSchema, input);
export const validateCommentForm = (input: unknown) => validateInput(commentFormSchema, input);
export const validateNewsletter = (input: unknown) => validateInput(newsletterSchema, input);
export const validateFileUpload = (input: unknown) => validateInput(fileUploadSchema, input);
export const validateUrlParams = (input: unknown) => validateInput(urlParamsSchema, input);

/**
 * Safe validation functions
 */
export const safeValidateSearchQuery = (input: unknown) => safeValidate(searchQuerySchema, input);
export const safeValidateContactForm = (input: unknown) => safeValidate(contactFormSchema, input);
export const safeValidateCommentForm = (input: unknown) => safeValidate(commentFormSchema, input);
export const safeValidateNewsletter = (input: unknown) => safeValidate(newsletterSchema, input);
export const safeValidateFileUpload = (input: unknown) => safeValidate(fileUploadSchema, input);
export const safeValidateUrlParams = (input: unknown) => safeValidate(urlParamsSchema, input);
