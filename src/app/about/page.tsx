...
import { Mail, MapPin, Calendar, Code, Database, Globe, Smartphone, Users, Award, ExternalLink } from 'lucide-react';
import Link from 'next/link';

export const metadata: Metadata = {
  title: 'About | Personal Blog',
  description: 'Learn more about Adrian, a passionate web developer specializing in React, TypeScript, and modern web technologies.',
  keywords: ['about', 'developer', 'web development', 'react', 'typescript', 'nextjs'],
  openGraph: {
...
export default function AboutPage() {
  ...
  const structuredData = {
    ...
    description: 'A passionate web developer specializing in React, TypeScript, and modern web technologies.',
    url: process.env.NEXT_PUBLIC_APP_URL ? `${process.env.NEXT_PUBLIC_APP_URL}/about` : 'http://localhost:3000/about',
    knowsAbout: [
      'Web Development',
      'React',
      'TypeScript',
  ...
  const skills = [
    ...
    { name: 'Node.js & APIs', level: 85, icon: Database, color: 'bg-green-500' },
    { name: 'UI/UX Design', level: 80, icon: Smartphone, color: 'bg-purple-500' },
    { name: 'Database Design', level: 75, icon: Database, color: 'bg-orange-500' },
    { name: 'DevOps & Deployment', level: 70, icon: Globe, color: 'bg-red-500' }
  ];
  ...
  const experiences = [
    ...
    },
    {
      ...
      period: '2020 - 2022',
      description: 'Developed and maintained full-stack web applications using modern technologies. Collaborated with design and product teams to deliver user-centric solutions.',
      achievements: [
    ...
    },
    {
      ...
      period: '2019 - 2020',
      description: 'Started my professional journey building websites and learning modern web development practices. Gained experience in React, Node.js, and agile development.',
      achievements: [
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="text-center lg:text-left">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                  A passionate web developer with over 5 years of experience creating modern, 
                  user-friendly applications. I specialize in React, TypeScript, and building 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {skills.map((skill, index) => {
                ...
                return (
                  <div key={index} className="bg-white dark:bg-gray-900 rounded-lg p-6 shadow-md hover:shadow-lg transition-shadow duration-200">
