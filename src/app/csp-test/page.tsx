    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="space-y-6">
        <section className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
          ...
          <p className="mb-4">Open browser developer tools and check the Network tab to verify these headers:</p>
          <ul className="list-disc list-inside space-y-2 text-sm">
            <li><code>Content-Security-Policy</code> - Should include nonce values</li>
        ...
        <section className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
          ...
          <p className="mb-4">Current nonce value: <code className="bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded">{nonce}</code></p>
          
          {/* Test inline script with nonce */}
          <div className="mb-4">
            <h3 className="font-medium mb-2">Inline Script Test (with nonce):</h3>
            <button 
              id="nonce-test-btn" 
          ...
          <div className="mb-4">
            <h3 className="font-medium mb-2">Inline Style Test (with nonce):</h3>
            <div className="nonce-style-test">This text should be green if nonce styles work</div>
            <style 
              nonce={nonce}
              dangerouslySetInnerHTML={{
                __html: `
        ...
        <section className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
          ...
          <p className="mb-4">These elements should be blocked by CSP (check console for violations):</p>
          
          {/* This should be blocked - inline script without nonce */}
          <div className="mb-4">
            <h3 className="font-medium mb-2 text-red-600">Blocked: Inline Script (no nonce):</h3>
            <button 
          ...
          <div className="mb-4">
            <h3 className="font-medium mb-2 text-red-600">Blocked: External Script (untrusted domain):</h3>
            <script src="https://evil-domain.com/malicious.js"></script>
            <p className="text-sm text-gray-600">External script from untrusted domain (should be blocked)</p>
          </div>
        </section>
